...
public class ChooseAreaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//已经选择了城市且不是从WeatherActivity跳转过来，才会直接跳转到WeatherActivty
   ...
   /**
    * 捕获Back键，根据当前级别判断，此时应该返回市列表、省列表、还是退出
    */
	@Override
